    ...
    <div className="pt-32 pb-12 md:py-48 lg:py-59 relative z-0 overflow-x-clip">
      ...
      <div className="container relative z-10">
        <div className="flex flex-col items-center">
          ...
          <Image
            src={avatar}
            className="size-[100px] relative z-20"
            alt="Hitesh Mahto"
          />
          {/* Open for Work Box */}
          <div className="bg-gray-950 border border-gray-800 px-4 py-1.5 inline-flex items-center gap-4 rounded-lg relative z-20">
        ...
        <div className="max-w-lg mx-auto">
          ...
          <p className="mt-4 text-center text-white/60 md:text-lg">
            Driven by data, I transform raw numbers into actionable insights
            that empower smarter decisions. Let&apos;s transform your data into
            a strategic advantage!
          </p>
        </div>
        <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4">
          <button
            className="inline-flex items-center gap-2 border border-white/15 bg-white text-gray-900 h-12 px-6 rounded-xl z-20 hover:bg-gray-200 hover:text-gray-800 transition duration-200"
            onClick={() =>
