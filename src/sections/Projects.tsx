              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                <div className="lg:pb-16">
                  ...
                  <a href={project.liveLink} target="_blank">
                    <button className="bg-white text-gray-950 h-12 w-full md:w-auto px-6 lg:px-5 rounded-xl font-semibold inline-flex items-center justify-center gap-2 mt-8 md:mr-3">
